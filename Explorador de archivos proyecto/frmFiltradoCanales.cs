...
{
    public partial class frmFiltradoCanales : Form
    {
        ...
        private void redSlider_TextChanged(object sender, EventArgs e)
        {

        }

        private void greenSlider_VisibleChanged(object sender, EventArgs e)
        {
        ...
        {
            minGBox.Text = blueSlider.Min.ToString();
            maxGBox.Text = blueSlider.Max.ToString();
        }
        ...
        private void frmFiltradoCanales_Load(object sender, EventArgs e)
        {

        }

        public frmFiltradoCanales()
        {
            InitializeComponent();
